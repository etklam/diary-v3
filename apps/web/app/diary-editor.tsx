...
type EditorDraft = {form?:{date?:string;title?:string;content?:string;tags?:string[];thesis?:string|null;risk?:string|null;execution?:string|null};stockSymbols?:string;transactions?:StoredTransaction[];reviewTime?:string;reviewInstant?:string;reminders?:StoredReminder[]};
...
function mergeDraft(base:EditorSources,draft:EditorDraft):EditorSources{
 ...
 return {
  ...
  stockSymbols:stringOr(draft.stockSymbols,base.stockSymbols,300),
...
function restorableDraft(draft:EditorDraft|null,baseline:EditableState,initial:DiaryFields):EditorDraft|null{
 if(!draft)return null;
 const merged=canonicalState(mergeDraft(editableFromDiary(initial),draft));
