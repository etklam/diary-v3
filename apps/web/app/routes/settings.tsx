...
const copy = {
  'zh-TW': { title:'偏好設定', intro:'設定日記使用的語言、日期時區、預設工作頁與投資目標。', profile:'個人偏好', name:'名稱', language:'帳戶語言', startPage:'預設工作頁', startPageHint:'下次登入且沒有指定返回頁面時，會開啟這個頁面。', diaryLibrary:'日記庫', timeline:'時間軸', calendar:'日曆', timezone:'日期時區', deviceTimezone:'使用裝置時區', timezoneHint:'日記預設日期使用此時區，不會跟隨瀏覽器改變。例如 Asia/Taipei 或 America/New_York。', trades:'每月預期交易次數', profit:'預期獲利金額', holding:'預期平均持倉金額', targets:'投資目標', holidays:'統計時排除假日', holidaysHint:'保留這項統計偏好，供交易統計使用。', save:'儲存設定', saved:'設定已儲存。', login:'請先登入，再管理個人偏好。', exact:'金額會儲存至小數點後兩位。', security:'管理密碼與裝置' },
